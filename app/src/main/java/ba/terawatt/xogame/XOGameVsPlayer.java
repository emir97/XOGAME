 ...
 */
public class XOGameVsPlayer extends Activity{
                ...
                if (mBoardbuttons[location].isEnabled()){
                    if(mIsSinglePlayer){
                        ...
                        if(winner == 0){
                            ...
                            mPlayerOneCounter++;
                            mPlayerOneCount.setText(Integer.toString(mPlayerOneCounter));
                            Snackbar.make(findViewById(R.id.coordinator), "PLAYER 1 WIN", Snackbar.LENGTH_LONG).show();
                            mGameOver=true;
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                            ...
                            mPlayerTwoCounter++;
                            mPlayerTwoCount.setText(Integer.toString(mPlayerTwoCounter));
                            Snackbar.make(findViewById(R.id.coordinator), "PLAYER 2 WIN", Snackbar.LENGTH_LONG).show();
                            mGameOver=true;
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
